...
# with open("2_digits_runs/2_digits_10_exe_times.csv", 'r') as f:
#     mycsv = csv.reader(f)
#     next(mycsv)
#     for row in mycsv:
#         if not (row):    
...
dataframe = pd.read_csv("2_digits_runs/2_digits_10_exe_times.csv")

df1_10_exe = pd.read_csv (r'2_digits_runs/2_digits_10_exe_times.csv') 
df1_10_check = pd.read_csv (r'2_digits_runs/2_digits_10_check_times.csv') 
df1_20_exe = pd.read_csv (r'2_digits_runs/2_digits_20_exe_times.csv') 
df1_20_check = pd.read_csv (r'2_digits_runs/2_digits_20_check_times.csv') 
df1_30_exe = pd.read_csv (r'2_digits_runs/2_digits_30_exe_times.csv') 
df1_30_check = pd.read_csv (r'2_digits_runs/2_digits_30_check_times.csv') 
df1_100_exe = pd.read_csv (r'2_digits_runs/2_digits_100_exe_times.csv') 
df1_100_check = pd.read_csv (r'2_digits_runs/2_digits_100_check_times.csv') 
