...
with open("sizes.csv", 'r') as f:
    ...
    for row in mycsv:
        print(row)
        one_digit_10_pre_run.append(int(row[1])/1000000)
        two_digit_10_pre_run.append(int(row[2])/1000000)
        three_digit_10_pre_run.append(int(row[3])/1000000)
        hundret_10_pre_run.append(int(row[4])/1000000)
        check_10_pre_run.append(int(row[6])/1000000)
#labels = ['10', '20', '30', '100']
